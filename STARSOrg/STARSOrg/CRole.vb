...
Public Class CRole
    ...
    Private _mstrRoleID As String 'represents the RoleID in the RoleID field in table
...
#Region "Exposed Properties"
    ...
    Public ReadOnly Property GetSaveParameters() As ArrayList
        'this property's code will create the parameters for the stored procdeure to save a record
        Get
...
#End Region
    Public Function Save() As Integer
        ...
        If IsNewRole Then
            Dim params As New ArrayList
            params.Add(New SqlParameter("roleID", _mstrRoleID)) 'first parameter must match the name of the parameter name of table exactly. Second value is the value you're putting in
